...
export default function Sidebar() {
  ...
  return (
    <div className="w-[100px] border-r border-t-0 border-gray-300 lg:col-span-1 md:w-full">
      <div
        className="h-[65px] text-center text-grey-500 p-4 border-b border-gray-300 flex md:justify-end justify-center gap-3  cursor-pointer  "
        onClick={controlModal}
      >
        <p className=" hover:text-blue-900">Send New Message</p>
        <svg
          viewBox="0 0 194.436 194.436"
          className="w-5 h-5 text-grey-500 cursor-pointer hover:text-blue-900"
        >
          <path
